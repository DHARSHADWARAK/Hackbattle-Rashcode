            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  type="email"
                  id="email"
                  className="mt-1 p-2 w-full rounded-md bg-opacity-50 bg-white text-black"
                />
              </div>
              <div className="mb-4">
              ...
              <button type="submit" className="w-full p-3 bg-green-700 hover:bg-green-800 rounded-md font-bold">
                Register
              </button>
            </form>
